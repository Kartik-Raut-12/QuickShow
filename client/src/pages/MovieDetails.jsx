      ...
      <div className='flex flex-col md:flex-row gap-8 max-w-6xl mx-auto' >
        ...
        <div className='relative flex flex-col gap-3'>
          ...
          <div className='flex items-center flex-wrap gap-4 mt-4'>
            <button className='flex items-center gap-2 px-7 py-3 text-sm bg-gray-800 hover:bg-gray-900 trnasition rounded-md font-medium cursor-pointer active:scale-95'>
            ...
            <button className='bg-gray-700 p-2.5 rounded-full transition cursor-pointer active:scale-95'>
              <Heart onClick = {handleFavourite} className={`w-5 h-5 ${favouriteMovies.find(movie => movie._id ===id) ? 'fill-primary text-primary' : ""}`} />
            </button>
          </div>
